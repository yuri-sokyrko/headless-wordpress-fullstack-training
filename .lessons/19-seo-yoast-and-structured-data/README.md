...
| `<meta name="description">` | Yoast `seo.metaDesc` | trimmed excerpt, 155 chars | 19.2 |
| `<link rel="canonical">` | Yoast `seo.canonical` | `NEXT_PUBLIC_SITE_URL` + route | 19.2 |
| `<meta name="robots">` | Yoast `seo.metaRobotsNoindex` / `...Nofollow` | `index, follow` | 19.2 |
| `og:image` | Yoast `seo.opengraphImage.sourceUrl` | generated `opengraph-image.tsx` | 19.2 |
...
| 301s | a WordPress-managed redirect list | — | 19.4 |
