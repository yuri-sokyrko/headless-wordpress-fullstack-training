...
- [`InspectorControls` and control placement](https://developer.wordpress.org/block-editor/reference-guides/slotfills/inspector-controls/) — the slot itself, plus `BlockControls` for comparison
